...
<body>
  ...
  <div id="encabezado">
    ...
    <div id="titulos">
      <h1 id="titulo-reserva">Reservá tu lugar</h1><br>
     
      
    </div>
  </div>
  <form method="POST" id='formulario'><br>
    <label for="nombreAlumno"><b>Nombre y apellido del alumno/a:
      </b></label><br>
    <input type="text" id='nombreAlumno' name="nombreAlumno" placeholder='para quien es la clase' required min=2><br><br>
    <label for="nombre"><b>En caso de bebés-niños<br> nombre y apellido del familiar:</b></label><br>
    <input type="text" name="nombre" id='nombre'><br><br>


    <label><b>Fecha de Nacimiento del alumno/a:</b></label><br>
    <input type="number" class="fecha" min="1" max="31" id='nacimientoDia' name="nacimientoDia" required
      placeholder="Día">
    <input type="number" class="fecha" min="1" max="12" id='nacimientoMes' name="nacimientoMes" required
      placeholder="Mes">
    <input type="number" class="fecha" min="1930" max="2025" id='nacimientoAno' name="nacimientoAno" required
      placeholder="Año"><br><br>



    <label for="phone"><b>Tu número de teléfono:</b></label><br>
    <input type="tel" id='phone' name="phone" required placeholder="2324 123456" min=2><br><br>
    <label for="email"><b>Correo electrónico:</b></label><br>
    <input type="email" id='email' name="email" placeholder='mail@dominio.com' required><br><br>
    <br>

    <label><b>Hacemos descuentos si viene más de un miembro de la familia!</b><br> ¿Para cuántos miembros de tu flia
      reservás?</label><br><br>
    ...
    <label><b>¿Tiene alguna discapacidad?</b></label><br>
    ...
    <label><b>Tiene algun problema de salud?</b></label><br><br>
